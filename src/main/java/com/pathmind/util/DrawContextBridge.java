...
/**
 * Compatibility helpers for GuiGraphics border rendering across 1.21.x.
 */
public final class DrawContextBridge {
    ...
    private static java.lang.reflect.Method resolveFillLayerMethod() {
        Class<?> renderLayerClass = tryLoadClass("net.minecraft.client.renderer.RenderLayer", "net.minecraft.class_1921");
