...
public final class InputCompatibilityBridge {
    ...
    public static boolean hasControlDown() {
        ...
        return isKeyPressed(client, GLFW.GLFW_KEY_LEFT_CONTROL)
            || isKeyPressed(client, GLFW.GLFW_KEY_RIGHT_CONTROL);
    }
    ...
    public static boolean hasShiftDown() {
        ...
        Minecraft client = Minecraft.getInstance();
        return isKeyPressed(client, GLFW.GLFW_KEY_LEFT_SHIFT)
            || isKeyPressed(client, GLFW.GLFW_KEY_RIGHT_SHIFT);
    }
